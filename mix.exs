defmodule Membrane.SDK.Mixfile do
  ...
  defp deps do
    membrane_deps = [
      ...
      {:membrane_generator_plugin, "~> 0.10"},
      {:membrane_audio_mix_plugin, "~> 0.16"},
      {:membrane_audio_filler_plugin, "~> 0.3"},
      {:membrane_flv_plugin, "~> 0.12"},
      {:membrane_ffmpeg_swscale_plugin, "~> 0.15"},
      {:membrane_video_merger_plugin, "~> 0.9"},
      {:membrane_stream_plugin, "~> 0.4"},
      {:membrane_sdl_plugin, "~> 0.18"},
      {:membrane_ffmpeg_swresample_plugin, "~> 0.20"},
      {:membrane_udp_plugin, "~> 0.13"},
      {:membrane_mp3_mad_plugin, "~> 0.18"},
      {:membrane_mp3_lame_plugin, "~> 0.18"},
      {:membrane_fake_plugin, "~> 0.11"},
      {:membrane_hackney_plugin, "~> 0.11"},
      {:membrane_rtp_mpegaudio_plugin, "~> 0.14"},
      {:membrane_audiometer_plugin, "~> 0.12"},
      {:membrane_raw_audio_format, "~> 0.12"},
      {:membrane_ivf_plugin, "~> 0.7"},
      {:membrane_scissors_plugin, "~> 0.8"},
      {:membrane_flac_plugin, "~> 0.11"},
      {:membrane_ogg_plugin, "~> 0.3"},
      {:ex_libsrtp, "~> 0.7"},
      {:membrane_camera_capture_plugin, "~> 0.7"},
      {:membrane_ffmpeg_video_filter_plugin, "~> 0.13"},
      {:membrane_portaudio_plugin, "~> 0.19"},
      {:membrane_overlay_plugin, "~> 0.1"}
    ]
